    ...
    <div className='batteryservice-scndpart'>
      ...
      <div className='batteryservice-scndpart-details'>
        ...
        <div className='battery-cart'>
          <Link className='link-button' to='Cart'><button className='batterybutton'>+Add to Cart</button></Link>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className='batteryservices-firstpart'>
    ...
    <div className='batteryservice-scndpart'>
      ...
      <div className='batteryservice-scndpart-details'>
        ...
        <div className='battery-cart'>
          <Link to='Cart' className='link-button'><button className='batterybutton'>+Add to Cart</button></Link>
        </div>
      </div>
    </div>
  </div>
...
<div className='battery-search'>
  ...
  <div className='battery-search-name'>
    <span>Name :</span>
    <input className='battery-search-input' type="text" placeholder=' Name...' />
  </div>
  <div className='battery-search-name'>
    <span>Email :</span>
    <input className='battery-search-input' type="email" placeholder=' Email...' />
  </div>
  <div className='battery-search-name'>
    <span>Mobile No :</span>
    <input className='battery-search-input' type="numbers" placeholder=' Mobile Number...'/>
  </div>
  <div className='battery-search-name'>
    <span>Address :</span>
    <input  className='battery-search-input' type="text" placeholder=' Address...'/>
  </div>
