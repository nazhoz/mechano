  ...
  return (
    ...
    <div className='period-search'>
      ...
      <div className='period-search-name'>
        <span>Name :</span>
        <input className='period-search-input' type="text" placeholder=' Name...' />
      </div>
      <div className='period-search-name'>
        <span>Email :</span>
        <input className='period-search-input' type="email" placeholder=' Email...' />
      </div>
      <div className='period-search-name'>
        <span>Mobile No :</span>
        <input className='period-search-input' type="numbers" placeholder=' Mobile Number...'/>
      </div>
      <div className='period-search-name'>
        <span>Address :</span>
        <input  className='period-search-input' type="text" placeholder=' Address...'/>
      </div>
